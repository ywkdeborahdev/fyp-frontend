    ...
    return (
        <SvgIcon >
            <svg
                ...
                viewBox="0 0 512 512"
            >
                <circle cx="70.621" cy="132.414" r="70.621" fill="#504B5A"></circle>
                <circle cx="70.621" cy="132.414" r="35.31" fill="#625D6B"></circle>
                <circle cx="441.379" cy="132.414" r="70.621" fill="#504B5A"></circle>
                <circle cx="441.379" cy="132.414" r="35.31" fill="#625D6B"></circle>
                <ellipse
                    cx="256"
                    cy="264.828"
                    fill="#EDEDEE"
                ...
                <path
                    fill="#DCDBDE"
                    d="M326.621 432.552c-13.495 0-26.66-1.331-39.373-3.844-4.531-.896-4.58-7.249-.067-8.232 38.333-8.346 65.923-32.419 65.923-67.372 0-35.31-47.464-88.276-97.103-88.276-40.455 0-79.362 35.151-92.392 67.277-1.647 4.063-7.377 4.171-9.471.319-13.876-25.522-21.724-54.51-21.724-85.251 0-73.894 45.302-137.672 110.833-167.454-125.703 5.156-225.592 86.055-225.592 185.109 0 102.382 106.711 185.379 238.345 185.379 40.899 0 79.384-8.023 113.018-22.14a203.5 203.5 0 0 1-42.397 4.485"
                ></path>
                <g fill="#504B5A">
                    <path d="M185.379 238.345c0 26.483-17.655 97.103-61.793 97.103-26.483 0-52.966-26.483-44.138-61.793s44.138-70.621 70.621-70.621c19.501 0 35.31 15.81 35.31 35.311M326.621 238.345c0 26.483 17.655 97.103 61.793 97.103 26.483 0 52.966-26.483 44.138-61.793s-44.138-70.621-70.621-70.621c-19.501 0-35.31 15.81-35.31 35.311M341.69 346.862a8.825 8.825 0 0 0-12.483 0l-8.293 8.289c-3.914 3.905-9.517 5.775-14.983 5l-41.103-5.874v-23.66c1.009-.359 2.046-.606 3.016-1.09l14.44-7.22a16.33 16.33 0 0 0 9.027-14.606v-.06c0-9.02-7.311-16.331-16.331-16.331h-37.959c-9.02 0-16.331 7.311-16.331 16.331v.059a16.33 16.33 0 0 0 9.027 14.606l14.44 7.22c.969.484 2.007.732 3.016 1.09v23.659l-41.095 5.87c-5.543.806-11.078-1.09-14.991-4.991l-8.294-8.293a8.825 8.825 0 0 0-12.483 0 8.825 8.825 0 0 0 0 12.483l8.294 8.298c7.828 7.815 19.069 11.556 29.965 9.983L256 370.849l47.439 6.781c1.638.233 3.285.345 4.922.345 9.293 0 18.388-3.694 25.035-10.336l8.294-8.293a8.825 8.825 0 0 0 0-12.484"></path>
                </g>
                <g fill="#8D8A94">
                    <path d="M150.069 260.414c-7.31 0-13.241-5.927-13.241-13.241v-8.828c0-7.315 5.931-13.241 13.241-13.241s13.241 5.927 13.241 13.241v8.828c0 7.314-5.931 13.241-13.241 13.241M361.931 260.414c-7.31 0-13.241-5.927-13.241-13.241v-8.828c0-7.315 5.931-13.241 13.241-13.241s13.241 5.927 13.241 13.241v8.828c0 7.314-5.931 13.241-13.241 13.241"></path>
                </g>
            </svg>
        </SvgIcon >
    );
    ...
    return (
        <SvgIcon>
            ...
            >
                <path
                    fill="#BDD2EF"
                    d="M841.3 910c-15.6 0-31.1-6.1-42.7-18.3L611.2 694c-22.3-23.6-21.3-60.7 2.2-83.1 23.6-22.3 60.8-21.3 83.1 2.2l187.4 197.7c22.3 23.6 21.3 60.7-2.2 83.1-11.4 10.8-25.9 16.1-40.4 16.1"
                ></path>
                <path
                    fill="#2867CE"
                    d="M450.4 760.7c-3 0-5.9 0-8.9-.1-86-2.3-166-38-225.2-100.4-59.2-62.5-90.5-144.2-88.2-230.2s38-166 100.4-225.2c62.5-59.2 144.2-90.5 230.2-88.2s166 38 225.2 100.4c59.2 62.5 90.5 144.2 88.2 230.2s-38 166-100.4 225.2c-60.3 57.1-138.6 88.3-221.3 88.3m-.4-548.2c-58.1 0-113 21.9-155.3 62-43.8 41.5-68.8 97.6-70.5 158-1.6 60.3 20.4 117.7 61.9 161.5s97.6 68.8 158 70.5c60.3 1.6 117.7-20.4 161.5-61.9s68.8-97.6 70.5-158c1.6-60.3-20.3-117.7-61.9-161.5-41.5-43.8-97.6-68.8-158-70.5-2.1 0-4.1-.1-6.2-.1"
                ></path>
            </svg>
        </SvgIcon>
    )
